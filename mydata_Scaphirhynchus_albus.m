...
%           bibkey.tL_f2 = 'Daigetal2023'; comment.tL_f2 = 'forklength acquired using conversion from total length FL=(TL-47.59)/1.04'; % play around with f values starting at f = 0.5 and move up or down to best fit data
%           
...
%           Ww0.tWw_f3 = 3262.9; units.Ww0.tWw_f3 = 'g'; label.Ww0.tWw_f3 = 'initial wet weight (g)'; %average initial wet weight
          ...
          bibkey.tWw_f3 = 'Daigetal2023'; comment.tWw_f3 = 'fed same ration for 4.5 months, beginning at day 0, f= HIGH'; % play around with f values starting at f = 0.5 and move up to best fit data
...
%           Lw0.tL_f3 = 81.2; units.Lw0.tL_f3 = 'cm'; label.Lw0.tL_f3 = 'initial fork length (cm)'; %average initial fork length
          ...
          bibkey.tL_f3 = 'Daigetal2023'; comment.tL_f3 = 'forklength acquired using conversion from total length FL=(TL-47.59)/1.04'; % play around with f values starting at f = 0.5 and move up to best fit data
...
%set4 = {'tL_f1', 'tL_f2', 'tL_f3'}; comment4 = {'Data for length with 3
%feeding groups'}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
bibkey = 'Daigetal2023'; type = 'Article'; bib = [ ...    
